                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="comments-list">
                                                                    ...
                                                                    <?php
                                                                    $yorumsor=$db->prepare("SELECT yorumlar.*,kullanici.* FROM yorumlar INNER JOIN kullanici ON 
                                                                        yorumlar.kullanici_id=kullanici.kullanici_id where urun_id=:id order by yorum_zaman DESC");
                                                                    ...
                                                                    <div class="media">
                                                                        ...
                                                                        <h4 class="media-heading user_name"><img style="border-radius: 30px; float: left;
                                                                         margin-right: 10px;" width="32" height="32" class="img-responsive"
                                        ...
                                        <h3 class="sidebar-item-title">Ürün Fiyatı</h3>
                                            ...
                                            <div align="center">
                                                ...
                                                <ul class="sidebar-product-btn">
                                                    ...
                                                    <li><a href="login" class="buy-now-btn" id="buy-button"><i class="fa fa-ban" aria-hidden="true"></i>Giriş Yap</a></li>
