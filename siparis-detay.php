                            ...
                            <div class="personal-info inner-page-padding">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $sipariscek ['urun_fiyat'] ?> TL</td>
                                        <td><?php

                                            if ($sipariscek['siparisdetay_onay']==1) {?>

                                                <a onclick="return confirm('Ürüne Onay Veriyor musunuz ?')" href="nedmin/netting/kullanici.php?urunonay=ok&siparisdetay_id=<?php echo $sipariscek['siparisdetay_id'] ?>&siparis_id=<?php echo $sipariscek['siparis_id'] ?>"><button class="btn btn-warning btn-xs"> Onay Ver</button></a>
                                            ...
                                            <div class="personal-info inner-page-padding">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div align="right" class="col-sm-12">
                                                        <button class="update-btn" name="puanyorumekle" id="login-update">Yorumu Kaydet</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <p>Bu ürün için yorum ve oylama yapılmıştır.</p>
