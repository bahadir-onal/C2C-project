                            ...
                            <div class="personal-info inner-page-padding">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><a onclick="return confirm ('Bu Mesajı Silmek İstiyor musunuz ? Bu İşlem Geri Alınamaz') " href="nedmin/netting/kullanici.php?gelenmesajsil=ok&mesaj_id=<?php echo $mesajcek ['mesaj_id'] ?>"><button class="btn btn-danger btn-xs">Sil</button></a></td>
