                            ...
                            <div class="fox-sidebar">
                                    ...
                                    <div class="sidebar-item-inner">
                                        ...
                                        <div class="sidebar-author-info">
                                            <div class="sidebar-author-img">
                                                <img style="width: 60px;" height="60px;" src="<?php echo $kullanicicek['kullanici_magazafoto']?>" alt="product" class="img-responsive">
                                            </div>
                                ...
                                <ul class="sidebar-product-btn">
                                    ...
                                    <?php }
                                        ...
                                        <li><button class="buy-now-btn" id="buy-button"><i class="fa fa-ban" disabled="" aria-hidden="true"></i>Mesaj Gönder</button></li>
                                ...
                                <div class="tab-pane fade active in" id="Products">
                                    ...
                                    <div class="inner-page-main-body"> 
                                         <div class="row more-product-item-wrapper">
                                             ...
                                             $urunsor=$db->prepare("SELECT urun.*,kategori.* FROM urun INNER JOIN
                                             kategori ON urun.kategori_id=kategori.kategori_id where urun.kullanici_id=:kullanici_id");
                                             ...
                                             <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6">
                                                <div class="more-product-item">
                                                    <div class="more-product-item-img">
                                                        <img style="width: 100px; height: 90px;" src="<?php echo $uruncek ['urunfoto_resimyol'] ?>" alt="product" class="<?php echo $uruncek ['urunfoto_ad'] ?>">
                                                    </div>
