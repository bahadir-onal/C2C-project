...
if (basename($_SERVER['PHP_SELF'])==basename(__FİLE__)) {
                            ...
                            <div class="row">                         
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            ...
                                            <div class="notify-message">
                                                ...
                                                <ul>
                                                    ...
                                                    $mesajsor=$db->prepare("SELECT mesaj.*,kullanici.* FROM mesaj INNER JOIN kullanici ON
                                                        mesaj.kullanici_gon=kullanici.kullanici_id where mesaj.kullanici_gel=:id and mesaj.mesaj_okunma
                                                        =:okunma order by mesaj_okunma,mesaj_zaman DESC");
                                                    ...
                                                    if ($mesajsor->rowCount()==0) { ?>
                                                        ...
                                                        <div style="color: black" class="notify-message-subject">Hiç Mesajınız Yok</div>
                                                        </div>
                                                        </li>
                                                    <?php }
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="notify-message-sign">
                                                            <a href="mesaj-detay?mesaj_id=<?php echo $mesajcek['mesaj_id']?>&kullanici_gon=<?php echo $mesajcek['kullanici_gon']?>"><i style="color: orange" class="fa fa-envelope-o" aria-hidden="true"></i></a>
                                                        </div>
                                                    </li>
                                    ...
                                    if (isset($_SESSION['userkullanici_mail'])) {?>
                                        ...
                                        <li><a class="apply-now-btn" href="logout.php" id="logout-button">Güvenli Çıkış</a></li>
