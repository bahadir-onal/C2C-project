                            ...
                            <div class="personal-info inner-page-padding">
                                ...
                                <table class="table table-striped">
                                    ...
                                    if (isset($db)) {
                                        ...
                                        siparis.siparis_id=siparis_detay.siparis_id INNER JOIN kullanici ON kullanici.kullanici_id=siparis_detay.kullanici_id
                                        INNER JOIN urun ON urun.urun_id=siparis_detay.urun_id where siparis.kullanici_idsatici=:kullanici_idsatici
                                        and siparis_detay.siparisdetay_onay=:onay or siparis_detay.siparisdetay_onay=:onays order by siparis_zaman DESC");
                                    }
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            <a onclick="return confirm('Ürünü Teslim Ediyorsunuz Bu İşlem Geri Alınamaz');"
                                               href="nedmin/netting/kullanici.php?urunteslim=ok&siparisdetay_id=
                                               <?php echo $sipariscek['siparisdetay_id'] ?>&siparis_id=
