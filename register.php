                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                          
                        <div class="form-group">
                            ...
                            <input type="text" id="first-name" required="" name="kullanici_mail" placeholder="Mail Adresinizi Giriniz(Kullanıcı Adınız Olacaktır)" class="form-control">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                          
                        <div class="form-group">
                            ...
                            <input type="text" id="first-name" required="" placeholder="Şifrenizi Giriniz." name="kullanici_passwordone" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                          
                        <div class="form-group">
                            <label class="control-label" for="last-name">Şifreniz Tekrar *</label>
                            <input type="text" id="last-name" required="" placeholder="Şifrenizi Tekrar Giriniz." name="kullanici_passwordtwo" class="form-control">
                        </div>
                    </div>
                </div>
